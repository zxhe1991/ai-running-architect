...
def commit_and_push():
    ...
    try:
        ...
        if result.returncode != 0:
            ...
            print("2. git commit -m 'Remove default historical data display, use user-defined data only'")
    ...
    # 提交
    print("\n2. 提交更改...")
    commit_message = "Remove default historical data display, use user-defined data only"
